...
with ic2:
    ...
    nfa=st.number_input("**Natural fine aggregate [kg\/m^3]:**", min_value=30.0, max_value=50.0, step=1.0, value=40)
...
with ic3:
    cca = st.number_input("**Ceramic coarse aggregate [kg\/m^3]:**", min_value=0.0, max_value=32.13, step=1, value=12.85)
